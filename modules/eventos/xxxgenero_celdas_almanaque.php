...
if($fecha_problema=="2012-04-12"){$total_eventos_fecha_problema=5;}
if($fecha_problema=="2012-04-13"){$total_eventos_fecha_problema=5;}
if($fecha_problema=="2012-04-16"){$total_eventos_fecha_problema=5;}
...
if($fecha_problema=="2012-04-12"){$recuento_contenidos_fecha_problema=5;}
if($fecha_problema=="2012-04-13"){$recuento_contenidos_fecha_problema=5;}
if($fecha_problema=="2012-04-16"){$recuento_contenidos_fecha_problema=5;}
